    ...
    <div style="padding: 20px; max-width: 1200px;">
      ...
      <div class="examples-section">
        <div class="example-item">
          <h3 class="example-title">Accordion</h3>
          <p class="example-desc">Accordion 示例</p>
...
export const Default: Story = {
  render: (args) => html`
    <nv-collapse ?accordion="${ args.accordion }" @change="${ (e: CustomEvent) => console.log('Change:', e.detail) }">
