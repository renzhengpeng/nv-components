  ...
  render: () => {
    ...
    <div style="padding: 20px; max-width: 1200px;">
      ...
      <div class="examples-section">
        ...
        <div class="example-item">
          <h3 class="example-title">With Push</h3>
          <p class="example-desc">With Push 示例</p>
          <div class="example-demo">
            ${ WithPush.render?.({} as any, {} as any) }
          </div>
        </div>
        ...
        <div class="example-item">
          <h3 class="example-title">With Pull</h3>
          <p class="example-desc">With Pull 示例</p>
          <div class="example-demo">
            ${ WithPull.render?.({} as any, {} as any) }
          </div>
        </div>
        ...
        <div class="example-item">
          <h3 class="example-title">Complex</h3>
          <p class="example-desc">Complex 示例</p>
          <div class="example-demo">
  ...
  render: (args) => html`
    <nv-row>
      <nv-col
        ...
        pull="${ args.pull }"
      >
        <div style="background: #d3dce6; padding: 20px; text-align: center; color: #333;">
          col-${ args.span }
        </div>
      </nv-col>
    </nv-row>
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <nv-row>
        ...
        <nv-col span="6" offset="6">
          <div style="background: #e5e9f2; padding: 20px; text-align: center; color: #333;">col-6 offset-6</div>
        </nv-col>
      </nv-row>
      <nv-row>
        <nv-col span="6" offset="6">
          <div style="background: #d3dce6; padding: 20px; text-align: center; color: #333;">col-6 offset-6</div>
        </nv-col>
      </nv-row>
    </div>
  `
...
export const WithPush: Story = {
  render: () => html`
    <nv-row>
      ...
      <nv-col span="6" push="6">
        <div style="background: #e5e9f2; padding: 20px; text-align: center; color: #333;">col-6 push-6</div>
      </nv-col>
    </nv-row>
  `
};

export const WithPull: Story = {
  render: () => html`
    <nv-row>
      <nv-col span="6" pull="6">
        <div style="background: #d3dce6; padding: 20px; text-align: center; color: #333;">col-6 pull-6</div>
      </nv-col>
      <nv-col span="6">
...
export const Complex: Story = {
  render: () => html`
    <nv-row gutter="20">
      <nv-col span="6" offset="2">
        <div style="background: #d3dce6; padding: 20px; text-align: center; color: #333;">col-6 offset-2</div>
      </nv-col>
      <nv-col span="6" push="2">
        <div style="background: #e5e9f2; padding: 20px; text-align: center; color: #333;">col-6 push-2</div>
      </nv-col>
      <nv-col span="6" pull="2">
        <div style="background: #d3dce6; padding: 20px; text-align: center; color: #333;">col-6 pull-2</div>
      </nv-col>
    </nv-row>
  `
};
