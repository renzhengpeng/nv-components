  ...
  render: () => {
    ...
    <div style="padding: 20px; max-width: 1200px;">
      ...
      <div class="examples-section">
        ...
        <div class="example-item">
          <h3 class="example-title">Button Style</h3>
          <p class="example-desc">Button Style 示例</p>
          <div class="example-demo">
            ${ ButtonStyle.render?.({} as any, {} as any) }
          </div>
        </div>
        ...
        <div class="example-item">
          <h3 class="example-title">Button Style Sizes</h3>
          <p class="example-desc">Button Style Sizes 示例</p>
          <div class="example-demo">
            ${ ButtonStyleSizes.render?.({} as any, {} as any) }
          </div>
        </div>
...
export const Disabled: Story = {
  render: () => html`
    <nv-radio-group value="option1" disabled>
      <nv-radio value="option1" label="选项1">选项1</nv-radio>
      <nv-radio value="option2" label="选项2">选项2</nv-radio>
      <nv-radio value="option3" label="选项3">选项3</nv-radio>
    </nv-radio-group>
...
export const WithBorder: Story = {
  render: () => html`
    <nv-radio-group value="option1" size="medium">
      <nv-radio value="option1" label="选项1" border>选项1</nv-radio>
      <nv-radio value="option2" label="选项2" border>选项2</nv-radio>
      <nv-radio value="option3" label="选项3" border>选项3</nv-radio>
    </nv-radio-group>
  `
};
...
export const BorderSizes: Story = {
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <nv-radio-group value="option1" size="mini">
        <nv-radio value="option1" label="选项1" border>选项1</nv-radio>
        <nv-radio value="option2" label="选项2" border>选项2</nv-radio>
      </nv-radio-group>
      <nv-radio-group value="option1" size="small">
        <nv-radio value="option1" label="选项1" border>选项1</nv-radio>
        <nv-radio value="option2" label="选项2" border>选项2</nv-radio>
      </nv-radio-group>
      <nv-radio-group value="option1" size="medium">
      ...
      <nv-radio-group value="option1" size="large">
        <nv-radio value="option1" label="选项1" border>选项1</nv-radio>
        <nv-radio value="option2" label="选项2" border>选项2</nv-radio>
      </nv-radio-group>
      <nv-radio-group value="option1" size="huge">
        <nv-radio value="option1" label="选项1" border>选项1</nv-radio>
        <nv-radio value="option2" label="选项2" border>选项2</nv-radio>
      </nv-radio-group>
    </div>
