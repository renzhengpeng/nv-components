...
- **测试页面**: http://localhost:6006/?path=/story/components-radiogroup--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1218 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 2 ms
- **Render delay**: 1216 ms

---

## 分析摘要

RadioGroup Overview 页（正确 URL：components-radiogroup--overview）LCP 约 1218 ms，表现优秀；CLS 0.00，良好。
