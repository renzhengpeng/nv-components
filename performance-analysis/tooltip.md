...
- **测试页面**: http://localhost:6006/?path=/story/components-tooltip--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1576 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 2 ms
- **Render delay**: 1574 ms

---

## 分析摘要

Tooltip Overview 页 LCP 约 1576 ms，CLS 0.00；点击「悬停我」触发 tooltip 后 INP 30 ms，交互响应优秀。
