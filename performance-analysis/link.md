...
- **测试页面**: http://localhost:6006/?path=/story/components-link--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 744 ms | < 2.5s | ✅ 优秀 |
| **CLS** (Cumulative Layout Shift) | 0.00 | < 0.1 | ✅ 良好 |
| **INP** (Interaction to Next Paint，如有交互) | — | < 200ms | —（链接点击易触发导航，本次未录得 INP） |
...
Link Overview 页 LCP 约 744 ms，CLS 0.00，表现优秀。
