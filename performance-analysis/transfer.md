...
- **测试页面**: http://localhost:6006/?path=/story/components-transfer--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1603 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1602 ms

---

## 分析摘要

Transfer Overview 页 LCP 约 1603 ms，CLS 0.00；选择列表项并点击右移后 INP 30 ms，交互响应优秀。
