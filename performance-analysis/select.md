...
- **测试页面**: http://localhost:6006/?path=/story/components-select--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1432 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1430 ms

---

## 分析摘要

Select Overview 页 LCP 约 1432 ms，CLS 0.00；点击选择器打开下拉后 INP 28 ms，交互响应优秀。
