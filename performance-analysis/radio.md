...
- **测试页面**: http://localhost:6006/?path=/story/components-radio--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1094 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1092 ms

---

## 分析摘要

Radio Overview 页 LCP 约 1094 ms，CLS 0.00；点击单选项「选项3」后 INP 29 ms，交互响应优秀。
