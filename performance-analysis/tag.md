...
- **测试页面**: http://localhost:6006/?path=/story/components-tag--overview
...
| **INP** (Interaction to Next Paint，如有交互) | — | < 200ms | —（未测交互） |
...
Tag Overview 页 LCP 约 941 ms，CLS 0.00；本次仅测加载，未测关闭等交互 INP。
