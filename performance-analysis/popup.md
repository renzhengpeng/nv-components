...
- **测试页面**: http://localhost:6006/?path=/story/components-popup--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1320 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1319 ms

---

## 分析摘要

Popup Overview 页 LCP 约 1320 ms，CLS 0.00；点击「点击触发」打开弹出层后 INP 30 ms，交互响应优秀。
