# CheckboxGroup 组件性能分析报告

## 测试环境

- **测试页面**: http://localhost:6006/?path=/story/components-checkboxgroup--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1362 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1360 ms

---

## 分析摘要

CheckboxGroup Overview 页（正确 URL：components-checkboxgroup--overview）LCP 约 1362 ms，表现优秀；CLS 0.00，良好。
