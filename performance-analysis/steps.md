...
- **测试页面**: http://localhost:6006/?path=/story/components-steps--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1469 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 2 ms
- **Render delay**: 1467 ms

---

## 分析摘要

Steps Overview 页 LCP 约 1469 ms，CLS 0.00；组件为展示型，无典型交互，未测 INP。
