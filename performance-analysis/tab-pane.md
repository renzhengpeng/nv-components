...
- **测试页面**: http://localhost:6006/?path=/story/components-tabpane--default
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 712 ms | < 2.5s | ✅ 优秀 |
...
TabPane Default 页（正确 URL：components-tabpane--default）LCP 约 712 ms，表现优秀；CLS 0.00，良好。
