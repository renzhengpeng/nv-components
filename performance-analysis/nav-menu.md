...
- **测试页面**: http://localhost:6006/?path=/story/components-navmenu--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1311 ms | < 2.5s | ✅ 优秀 |
...
NavMenu Overview 页（正确 URL：components-navmenu--overview）LCP 约 1311 ms，表现优秀；CLS 0.00，良好。
