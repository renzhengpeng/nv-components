...
- **测试页面**: http://localhost:6006/?path=/story/components-modal--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 780 ms | < 2.5s | ✅ 优秀 |
...
Modal Overview 页 LCP 约 780 ms，CLS 0.00；点击「打开对话框」后 INP 30 ms，弹窗打开交互响应优秀。
