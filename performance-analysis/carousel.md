...
- **测试页面**: http://localhost:6006/?path=/story/components-carousel--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1030 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 2 ms
- **Render delay**: 1028 ms

---

## 分析摘要

Carousel Overview 页 LCP 约 1030ms，CLS 为 0，无布局偏移，表现优秀。
