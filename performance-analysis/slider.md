...
- **测试页面**: http://localhost:6006/?path=/story/components-slider--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1568 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1566 ms

---

## 分析摘要

Slider Overview 页 LCP 约 1568 ms，CLS 0.00；滑块交互后 INP 13 ms，交互响应优秀。
