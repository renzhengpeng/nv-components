# ButtonGroup 组件性能分析报告

## 测试环境

- **测试页面**: http://localhost:6006/?path=/story/components-buttongroup--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1249 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 2 ms
- **Render delay**: 1247 ms

---

## 分析摘要

ButtonGroup Overview 页（正确 URL：components-buttongroup--overview）LCP 约 1249 ms，表现优秀；CLS 0.00，良好。
