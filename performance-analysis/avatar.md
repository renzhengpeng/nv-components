...
- **测试页面**: http://localhost:6006/?path=/story/components-avatar--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 400 ms | < 2.5s | ✅ 优秀 |
...
Avatar Overview 页 LCP 约 400ms，CLS 为 0，无布局偏移，表现优秀。

---

## 优化建议（如有）

_待补充：根据 Chrome Performance Insights 填写。_
