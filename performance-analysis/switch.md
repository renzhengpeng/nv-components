...
- **测试页面**: http://localhost:6006/?path=/story/components-switch--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 846 ms | < 2.5s | ✅ 优秀 |
...
Switch Overview 页 LCP 约 846 ms，CLS 0.00；点击开关切换后 INP 30 ms，交互响应优秀。
