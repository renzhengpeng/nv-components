...
- **测试页面**: http://localhost:6006/?path=/story/components-timeline--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1323 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1322 ms

---

## 分析摘要

Timeline Overview 页 LCP 约 1323 ms，CLS 0.00；组件为展示型，无典型交互，未测 INP。
