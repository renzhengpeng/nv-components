...
- **测试页面**: http://localhost:6006/?path=/story/components-tabs--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1610 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 2 ms
- **Render delay**: 1609 ms

---

## 分析摘要

Tabs Overview 页 LCP 约 1610 ms，CLS 0.00；点击「配置管理」切换标签后 INP 30 ms，交互响应优秀。
