...
- **测试页面**: http://localhost:6006/?path=/story/components-collapse--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1026 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1025 ms

---

## 分析摘要

Collapse Overview 页 LCP 约 1026ms，CLS 为 0，无布局偏移，表现优秀。
