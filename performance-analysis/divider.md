...
- **测试页面**: http://localhost:6006/?path=/story/components-divider--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 983 ms | < 2.5s | ✅ 优秀 |
...
Divider Overview 页 LCP 约 983ms，CLS 为 0，无布局偏移，表现优秀。
