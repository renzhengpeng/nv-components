# Notification 组件性能分析报告

## 测试环境

- **测试页面**: http://localhost:6006/?path=/story/components-notification--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1312 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1310 ms

---

## 分析摘要

Notification Overview 页 LCP 约 1312 ms，CLS 0.00；点击「成功」触发通知后 INP 30 ms，交互响应优秀。
