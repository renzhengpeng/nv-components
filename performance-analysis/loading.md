...
- **测试页面**: http://localhost:6006/?path=/story/components-loading--overview
...
| 指标 | 测量值 | 阈值（良好） | 评级 |
|------|--------|--------------|------|
| **LCP** (Largest Contentful Paint) | 1224 ms | < 2.5s | ✅ 优秀 |
...
- **TTFB**: 1 ms
- **Render delay**: 1222 ms

---

## 分析摘要

Loading Overview 页 LCP 约 1224 ms，CLS 0.00，表现优秀；无典型用户交互，未测 INP。
